...
void CNetworkLibrary::StartDemoPlay_t(const CTFileName &fnDemo)  // throw char *
{
  ...
  // remember the world pointer
  _pShell->SetINDEX("pwoCurrentWorld", (INDEX)&ga_World); // ### _pShell->SetCurrentWorld(&ga_World);
...
void CNetworkLibrary::StopGame(void)
{
	...
	*/
	...
	_pShell->SetCurrentWorld(nullptr);
...
*/
	...
	packet->mode = 0;
	// #####################################################
	// ### Use USE_2015_SERVER for choose server for client
	// ### For 2015 server ->  ulVersion;
	// ### For 2018 server ->  VERSION_FOR_CLIENT;
	// #####################################################	
#ifndef USE_2015_SERVER	
	packet->version = VERSION_FOR_CLIENT; // ### 2018
#else
	packet->version = ulVersion; // ### 2015
#endif // USE_2015_SERVER
