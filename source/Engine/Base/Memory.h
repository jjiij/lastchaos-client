...
inline INDEX FindZero(UBYTE *pubMemory, INDEX iBytes)
{
...
// ### FindWord not used anywhere,  leave it as is
...
// ### FindLong using only in  Gfx_wrapper.cpp (Occlusion Query).
// return position (offset) where we encounter specified long or ctLongs
