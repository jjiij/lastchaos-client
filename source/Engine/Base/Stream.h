...
public:
  ...
  inline CTStream& operator>>(ULONG64& ull) { Read_t(&ull , sizeof(ull)); return *this; } // throw char *
  ...
  inline CTStream &operator<<(const ULONG64 & ull) { Write_t(&ull, sizeof(ull)); return *this; } // throw char *
