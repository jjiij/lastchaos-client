...
// ### Disabled - game crash when change level to dratan
...
public:
	...
	// DirectX info
	IDirect3D9* gl_pD3D9;       // used to create the D3DDevice
	IDirect3DDevice9* gl_pd3d9Device = nullptr; // rendering device
	IDirect3DSwapChain9* vp9_pSwapChain = nullptr;  // swap chain for D3D
	IDirect3DSurface9* vp9_pSurfDepth = nullptr;  // z-buffer for D3D
	...
	LPDIRECT3DVERTEXBUFFER9 gl_pd3dVtx;
	LPDIRECT3DVERTEXBUFFER9 gl_pd3dNor;
//안태훈 수정 시작	//(Add Tagent-space Normal Map)(0.1)
	LPDIRECT3DVERTEXBUFFER9 gl_pd3dTan;
//안태훈 수정 끝	//(Add Tagent-space Normal Map)(0.1)
	LPDIRECT3DVERTEXBUFFER9 gl_pd3dWgh;
	LPDIRECT3DVERTEXBUFFER9 gl_pd3dCol[GFX_MAXLAYERS];
	LPDIRECT3DVERTEXBUFFER9 gl_pd3dTex[GFX_MAXLAYERS];
	LPDIRECT3DINDEXBUFFER9  gl_pd3dIdx;
	...
	LPDIRECT3DPIXELSHADER9 gl_dwPixelShader;
	//ULONG64 gl_dwVertexShader;
	//ULONG64 gl_dwPixelShader;
	...
	LPDIRECT3DPIXELSHADER9 _ps[1000];

	std::unordered_map<ULONG64, stVertexShaderInfo*> mapVS;
	std::unordered_map<ULONG64, LPDIRECT3DPIXELSHADER9> mapPS;
    //  ### DX9 end
private:
...
public:
	...
	ULONG64 SavePixelShader(LPDIRECT3DPIXELSHADER9 ps);

	stVertexShaderInfo* GetVertexShader(ULONG64 ulHandle);
	LPDIRECT3DPIXELSHADER9 GetPixelShader(ULONG64 ulHandle);
	...
	void DeletePixelShader(ULONG64 ulHandle);
    //  ### DX9 end
