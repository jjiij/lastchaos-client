...
{
	LPDIRECT3DPIXELSHADER9 pph_ulHandle = NULL;        // Pixel shader handle
};
...
ENGINE_API void shaSetNormalBufferID(INDEX iNormalBufferID, INDEX iFirstVertex, INDEX ctVertices);
//안태훈 수정 시작	//(Add Tagent-space Normal Map)(0.1)
ENGINE_API void shaSetTangentBufferID(INDEX iTagentBufferID, INDEX iFirstVertex, INDEX ctVertices);
//안태훈 수정 끝	//(Add Tagent-space Normal Map)(0.1)
// Set weight buffer ID
ENGINE_API void shaSetWeightBufferID(INDEX iWeightBufferID, INDEX iFirstVertex, INDEX ctVertices);
