...
ENGINE_API extern BOOL TR_AreHardwareShadersAvailable(void)
{
	...
	// ### In OpenGL we are simply going back
	// ### The presence of directx byte code only affects the water effect and a couple of effects. 
	// ### It's not worth the effort to translate directx bytecode into arb opengl
...
//안태훈 수정 시작	//(Terrain Render for No Shader)(0.1)
					else if (!_bUseHardwareShaders  && sam_iGfxAPI == GAT_D3D )
					{
						// save old
						_pGfx->gl_pd3d9Device->GetRenderState(D3DRS_TEXTUREFACTOR, &dw_tfactor);
						_pGfx->gl_pd3d9Device->GetTextureStageState(0, D3DTSS_COLORARG1, &dw_tss_ta_value0_arg1);
						_pGfx->gl_pd3d9Device->GetTextureStageState(0, D3DTSS_COLORARG2, &dw_tss_ta_value0_arg2);
						_pGfx->gl_pd3d9Device->GetTextureStageState(0, D3DTSS_COLORARG0, &dw_tss_ta_value0_arg0);
						_pGfx->gl_pd3d9Device->GetTextureStageState(0, D3DTSS_COLOROP, &dw_tss_top_value0);
						_pGfx->gl_pd3d9Device->GetTextureStageState(1, D3DTSS_COLORARG1, &dw_tss_ta_value1_arg1);
						_pGfx->gl_pd3d9Device->GetTextureStageState(1, D3DTSS_COLORARG2, &dw_tss_ta_value1_arg2);
						_pGfx->gl_pd3d9Device->GetTextureStageState(1, D3DTSS_COLORARG0, &dw_tss_ta_value1_arg0);
						_pGfx->gl_pd3d9Device->GetTextureStageState(1, D3DTSS_COLOROP, &dw_tss_top_value1);
						_pGfx->gl_pd3d9Device->GetTextureStageState(0, D3DTSS_ALPHAOP, &dw_tss_aop_value0);
						_pGfx->gl_pd3d9Device->GetTextureStageState(1, D3DTSS_ALPHAOP, &dw_tss_aop_value1);
						_pGfx->gl_pd3d9Device->GetTextureStageState(2, D3DTSS_COLOROP, &dw_tss_top_value2);

						// setting new
						_pGfx->gl_pd3d9Device->SetTextureStageState(0, D3DTSS_COLORARG1, D3DTA_TEXTURE);
						_pGfx->gl_pd3d9Device->SetTextureStageState(0, D3DTSS_COLORARG2, D3DTA_CURRENT);
						_pGfx->gl_pd3d9Device->SetTextureStageState(0, D3DTSS_COLOROP, D3DTOP_SELECTARG1);
						_pGfx->gl_pd3d9Device->SetTextureStageState(1, D3DTSS_COLORARG1, D3DTA_CURRENT);
						_pGfx->gl_pd3d9Device->SetTextureStageState(1, D3DTSS_COLORARG2, D3DTA_TEXTURE);
						_pGfx->gl_pd3d9Device->SetTextureStageState(1, D3DTSS_COLORARG0, D3DTA_TFACTOR);
						_pGfx->gl_pd3d9Device->SetTextureStageState(1, D3DTSS_COLOROP, D3DTOP_LERP);
						_pGfx->gl_pd3d9Device->SetTextureStageState(0, D3DTSS_ALPHAOP, D3DTOP_DISABLE);
						_pGfx->gl_pd3d9Device->SetTextureStageState(1, D3DTSS_ALPHAOP, D3DTOP_DISABLE);
						_pGfx->gl_pd3d9Device->SetTextureStageState(2, D3DTSS_COLOROP, D3DTOP_DISABLE);
						UBYTE ubBlendFactor = 0xFF * ptr->tr_fShadowBlendFactor;
						DWORD dwBlendFactor = (ubBlendFactor << 24) | (ubBlendFactor << 16) | (ubBlendFactor << 8) | ubBlendFactor;
						dwBlendFactor |= 0xFF000000;
						_pGfx->gl_pd3d9Device->SetRenderState(D3DRS_TEXTUREFACTOR, dwBlendFactor);
					...
					else if (!_bUseHardwareShaders && sam_iGfxAPI == GAT_OGL) { // OpenGL
						// ### TODO:
						// ### TODO:
						shaSetTexCoordArray( ptcTexCoords, 0 );
						shaSetTextureMatrix( tt.tt_mShadowMap, 0 );
					...
					shaEnd();
					// restore old
					if(!_bUseHardwareShaders && sam_iGfxAPI == GAT_D3D)
					{
						_pGfx->gl_pd3d9Device->SetRenderState(D3DRS_TEXTUREFACTOR, dw_tfactor);
						_pGfx->gl_pd3d9Device->SetTextureStageState(0, D3DTSS_COLORARG1, dw_tss_ta_value0_arg1);
						_pGfx->gl_pd3d9Device->SetTextureStageState(0, D3DTSS_COLORARG2, dw_tss_ta_value0_arg2);
						_pGfx->gl_pd3d9Device->SetTextureStageState(0, D3DTSS_COLORARG0, dw_tss_ta_value0_arg0);
						_pGfx->gl_pd3d9Device->SetTextureStageState(0, D3DTSS_COLOROP, dw_tss_top_value0);
						_pGfx->gl_pd3d9Device->SetTextureStageState(1, D3DTSS_COLORARG1, dw_tss_ta_value1_arg1);
						_pGfx->gl_pd3d9Device->SetTextureStageState(1, D3DTSS_COLORARG2, dw_tss_ta_value1_arg2);
						_pGfx->gl_pd3d9Device->SetTextureStageState(1, D3DTSS_COLORARG0, dw_tss_ta_value1_arg0);
						_pGfx->gl_pd3d9Device->SetTextureStageState(1, D3DTSS_COLOROP, dw_tss_top_value1);
						_pGfx->gl_pd3d9Device->SetTextureStageState(0, D3DTSS_ALPHAOP, dw_tss_aop_value0);
						_pGfx->gl_pd3d9Device->SetTextureStageState(1, D3DTSS_ALPHAOP, dw_tss_aop_value1);
						_pGfx->gl_pd3d9Device->SetTextureStageState(2, D3DTSS_COLOROP, dw_tss_top_value2);
					}
					else if (!_bUseHardwareShaders && sam_iGfxAPI == GAT_OGL) {
						// ### TODO:
					}
					TR_SETINFO( ti_ctVisibleTriangles += ctind / 3 );
				}
...
extern void TR_RenderTerrainLighting( CTerrain *ptrTerrain, CTextureData* ptdTexture )
{
	...
	for( iterLightSource = _lstTerrainLightSource.begin(); iterLightSource != _lstTerrainLightSource.end(); iterLightSource++ )
	{
		...
		if (ctVertices <= 0 || ctIndices <= 0 || ctVertices > 65536 || ctIndices > 65536)//liquid fix pvs
			continue;
