...
protected:
	...
	std::vector<PIX>	m_vecPixAspectRatioI;
	std::vector<PIX>	m_vecPixAspectRatioJ;
...
protected:
	...
	void    UpdateComboResolutionList(void);
	void    UpdateComboAspectRatioList(void); // ###
	void    UpdateComboGraphicsAPI(void);
	void	FillAspectRatiosList(void);
	void	FillResolutionsList();
...
private:
	...
	CUIComboBox*		m_pComboAspectRatio; // ###
	CUIComboBox*		m_pComboGraphicsAPI; // ###
	CUICheckButton*		m_pChkFullscreen;
	CUICheckButton*		m_pChkBorderless;    // ###
