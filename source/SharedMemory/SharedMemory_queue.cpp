...
{
public:
	static void* getLowPrivSA() { return 0; }
};

static inline HANDLE CreateFileMapping(HANDLE, void*, int, int, size_t size, const char*)
{
...
: m_strMapName(0), m_iNodeSize(0), m_iNodeCount(0), m_iQueueCount(0), m_pQueueArray(0), m_hMapMem(0), m_pMappedPointer(0)
{
}
